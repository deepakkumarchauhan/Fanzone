...
@interface ZSSRichTextEditor ()<VSDropdownDelegate>
...
/*
 * VSDropDown to show the selection of Alignment and Fonts
 */
@property (strong, nonatomic) VSDropdown *vsDropDownObj;
...
- (void)viewDidLoad {
    ...
    //DropDownAllocation
    self.vsDropDownObj = [[VSDropdown alloc]initWithDelegate:self];
    [self.vsDropDownObj setAdoptParentTheme:YES];
    ...
    CGRect frameSourceTextView = CGRectMake(0, 112, self.view.frame.size.width, self.view.frame.size.height-260);
    
    //Source View
    [self createSourceViewWithFrame:frameSourceTextView];
    
    //Frame for the source view and editor view
    CGRect frameEditorView = CGRectMake(0,112, self.view.frame.size.width, self.view.frame.size.height-260);

    //Editor View
    [self createEditorViewWithFrame:frameEditorView];
...
- (void)createToolBarScroll {
    ...
    self.toolBarScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, [self isIpad] ? self.view.frame.size.width : self.view.frame.size.width, 50)];
...
- (void)createParentHoldingView {
    ...
    //Background Toolbar
    UIToolbar *backgroundToolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 50)];
...
//        self.toolbarHolder.frame = CGRectMake(0, self.view.frame.size.height - 44, self.view.frame.size.width, 44);
        self.toolbarHolder.frame = CGRectMake(0, 70, self.view.frame.size.width+44, 50);
    } else {
//        self.toolbarHolder.frame = CGRectMake(0, self.view.frame.size.height, self.view.frame.size.width, 44);
        self.toolbarHolder.frame = CGRectMake(0, 70, self.view.frame.size.width, 50);
    }
    ...
    [self.toolbarHolder setBackgroundColor:[UIColor lightGrayColor]];
...
//    NSBundle* bundle = [NSBundle bundleForClass:[ZSSRichTextEditor class]];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyLeft]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        [btn setImage:[UIImage imageNamed:@"align_icon9.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"align_icon9_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(alignLeft:) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        btn.tag = 99;
        ZSSBarButtonItem *alignLeft = [[ZSSBarButtonItem alloc] initWithCustomView:btn];
        
//        ZSSBarButtonItem *alignLeft = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"align_icon9.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(alignLeft:)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyCenter]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignCenter = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"align_icon8.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(alignCenter)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarJustifyRight]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ZSSBarButtonItem *alignRight = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"align_icon7.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(alignRight)];
    ...
    */
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarBold]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"b_icon6.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"b_icon6_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(setBold) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *bold = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
        
//        ZSSBarButtonItem *bold = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"b_icon6.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(setBold)];
        bold.label = @"bold";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarItalic]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"i_icon5.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"i_icon5_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(setItalic) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        btn.tag = 99;
        ZSSBarButtonItem *italic = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
        
//        ZSSBarButtonItem *italic = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"i_icon5.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(setItalic)];
        italic.label = @"italic";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarUnderline]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"u_icon4.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"u_icon4_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(setUnderline) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        btn.tag = 99;
        ZSSBarButtonItem *underline = [[ZSSBarButtonItem alloc]initWithCustomView:btn];

        
//        ZSSBarButtonItem *underline = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"u_icon4.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(setUnderline)];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRemoveFormat]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"ZSSclearstyle.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"ZSSclearstyle.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(removeFormat) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        btn.tag = 99;
        ZSSBarButtonItem *removeFormat = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
...
#warning need to understand the working and meaning of item
    // Undo
...
//        ZSSBarButtonItem *undoButton = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"br_icon3.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(undo:)];
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"br_icon3.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"br_icon3_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(undo:) forControlEvents:UIControlEventTouchUpInside];
        btn.frame = CGRectMake(0, 0, 40, 40);
        btn.tag = 99;
        ZSSBarButtonItem *undoButton = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarFonts]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"t_icon2.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"t_icon2_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(showFontsPicker:) forControlEvents:UIControlEventTouchUpInside];
        [btn setTag:98];
        btn.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *fonts = [[ZSSBarButtonItem alloc]initWithCustomView:btn];

//        ZSSBarButtonItem *fonts = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"t_icon2.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(showFontsPicker)];
        fonts.label = @"fonts";
        if (customOrder) {
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarRedo]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        [redoButton setImage:[UIImage imageNamed:@"ZSSredo.png"] forState:UIControlStateNormal];
      //  [redoButton setImage:[UIImage imageNamed:@"t_icon2_s.png"] forState:UIControlStateSelected];
        [redoButton addTarget:self action:@selector(redo:) forControlEvents:UIControlEventTouchUpInside];
        [redoButton setTag:98];
        redoButton.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *redoBar = [[ZSSBarButtonItem alloc]initWithCustomView:redoButton];
...
//        ZSSBarButtonItem *redoButton = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"ZSSredo.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(redo:)];
        ...
        if (customOrder) {
            [items replaceObjectAtIndex:[_enabledToolbarItems indexOfObject:ZSSRichTextEditorToolbarRedo] withObject:redoBar];
        } else {
            [items addObject:redoBar];
        }
    }
    ...
    */
    ...
    if ((_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarTextColor]) || (_enabledToolbarItems && [_enabledToolbarItems containsObject:ZSSRichTextEditorToolbarAll])) {
        ...
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"a_icon1.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"a_icon1_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(textColor) forControlEvents:UIControlEventTouchUpInside];
        [btn setTag:98];
        btn.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *textColor = [[ZSSBarButtonItem alloc]initWithCustomView:btn];

//        ZSSBarButtonItem *textColor = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"a_icon1.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(textColor)];
...
//        ZSSBarButtonItem *insertImageFromDevice = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"pickImage_icon10.png" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(insertImageFromDevice)];
        
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"pickImage_icon10.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"pickImage_icon10_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(insertImageFromDevice) forControlEvents:UIControlEventTouchUpInside];
        [btn setTag:98];
        btn.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *insertImageFromDevice = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
...
//        ZSSBarButtonItem *bgColor = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"bg_text_icon11" inBundle:bundle compatibleWithTraitCollection:nil] style:UIBarButtonItemStylePlain target:self action:@selector(bgColor)];
        UIButton * btn = [UIButton buttonWithType:UIButtonTypeCustom];
        [btn setImage:[UIImage imageNamed:@"bg_text_icon11.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"bg_text_icon11_s.png"] forState:UIControlStateSelected];
        [btn addTarget:self action:@selector(bgColor) forControlEvents:UIControlEventTouchUpInside];
        [btn setTag:98];
        btn.frame = CGRectMake(0, 0, 40, 40);
        ZSSBarButtonItem *bgColor = [[ZSSBarButtonItem alloc]initWithCustomView:btn];
...
- (void)alignLeft:(UIButton *)alignLeft {
    
    [self showDropDownForButton:alignLeft adTextContents:[NSArray arrayWithObjects:@"Align Left",@"Align Center",@"Align Right", nil] andImageContent:[NSArray arrayWithObjects:@"align_icon9.png",@"align_icon8.png",@"align_icon7.png", nil] multipleSelection:NO andDropdownType:DropdownType_Align];
...
- (void)showFontsPicker : (UIButton *)sender{
...
//    [self.navigationController pushViewController:fontPicker animated:YES];
    ...
    [self showDropDownForButton:sender adTextContents:[NSArray arrayWithObjects:@"1",@"2",@"3",@"4",@"5",@"6", nil] andImageContent:[NSArray array] multipleSelection:NO andDropdownType:DropdownType_FontSize];
...
- (void)updateToolBarWithButtonName:(NSString *)name {
    ...
    for (ZSSBarButtonItem *item in items) {
        ...
        UIButton *barButtonView = item.customView;
        if([barButtonView isKindOfClass:[UIButton class]]) {
            if ([itemNames containsObject:item.label]) {
                [barButtonView setSelected:YES];
            }
//            else if ([itemNames containsObject:@"h1"] || [itemNames containsObject:@"h2"] || [itemNames containsObject:@"h3"] || [itemNames containsObject:@"h4"] || [itemNames containsObject:@"h5"] || [itemNames containsObject:@"h6"] || [itemNames containsObject:@"justifyRight"] || [itemNames containsObject:@"justifyCenter"]) {
//                [barButtonView setSelected:YES];
//            }
            else {
                 [barButtonView setSelected:NO];
            }
        }
        if ([itemNames containsObject:item.label]) {
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *, id> *)info{
    ...
    [[FFUtility sharedInstance] saveSharedImage:selectedImage];
    ...
    if ([notification.name isEqualToString:UIKeyboardWillShowNotification]) {
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
          ...
          //  self.toolbarHolder.frame = frame;
            ...
            sourceFrame.size.height = (self.view.frame.size.height - keyboardHeight) - sizeOfToolbar - extraHeight-260;
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
            ...
            if (_alwaysShowToolbar) {
                ...
                frame.origin.y = self.view.frame.size.height + keyboardHeight-260;
            }
...
//            
            if (_alwaysShowToolbar) {
                ...
                editorFrame.size.height = self.view.frame.size.height-260;
            }
            self.editorView.frame = editorFrame;
            self.editorViewFrame = self.editorView.frame;
            self.editorView.scrollView.contentInset = UIEdgeInsetsZero;
...
//            }
            ...
            if (_alwaysShowToolbar) {
                ...
                sourceFrame.size.height = self.view.frame.size.height-260;
            }
            self.sourceView.frame = sourceFrame;
...
-(void)showDropDownForButton:(UIButton *)sender adTextContents:(NSArray *)contents andImageContent : (NSArray *)images multipleSelection:(BOOL)multipleSelection andDropdownType: (DropdownType)dropdownType{

    [self.vsDropDownObj setTag:sender.tag];
    [self.vsDropDownObj setDrodownAnimation:rand()%2];
     [self.vsDropDownObj setAssignedDropdownType:dropdownType];
    [self.vsDropDownObj setAllowMultipleSelection:multipleSelection];
    [self.vsDropDownObj setupDropdownForView:sender];
    [self.vsDropDownObj setSeparatorColor:[UIColor darkGrayColor]];
    [self.vsDropDownObj setShouldSortItems:NO];
    [self.vsDropDownObj reloadDropdownWithContents:contents imageNames:images selectedItems:nil];
}
