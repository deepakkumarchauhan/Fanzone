...
@interface FFConnectionsViewController ()<UIPageViewControllerDelegate, UIPageViewControllerDataSource>
{
    UIButton * button;
    UIButton * settings;
    UIView * customView;
...
@implementation FFConnectionsViewController
...
-(void)manageNavigationBar
{
    ...
    headerImage.image = [UIImage imageNamed:@"connection"];
...
-(void)initiatePageController
{
    ...
    FFConnectionListViewController *initialViewController = [self viewControllerAtIndex:0];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    NSUInteger index = [(FFConnectionListViewController *)viewController index];
...
- (FFConnectionListViewController *)viewControllerAtIndex:(NSUInteger)index {
    
    FFConnectionListViewController *childViewController = (FFConnectionListViewController*)[self.storyboard instantiateViewControllerWithIdentifier:@"FFConnectionListViewController"];
...
- (void)changePage:(UIPageViewControllerNavigationDirection)direction toIndex:(NSInteger)toIndex{
    NSUInteger pageIndex = ((FFConnectionListViewController *) [self.pageViewController.viewControllers objectAtIndex:0]).index;
    ...
    FFConnectionListViewController *viewController = [self viewControllerAtIndex:toIndex];
