...
@interface FFPostCommentsTableViewCell ()<UIGestureRecognizerDelegate>
...
@implementation FFPostCommentsTableViewCell
    ...
    switch (recognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
            if (self.startingRightLayoutConstraintConstant == 0) { //1
                //We were opening
                CGFloat halfOfButtonOne = CGRectGetWidth(self.likeBtn.frame) / 2; //2
                ...
                //We were closing
                CGFloat buttonOnePlusHalfOfButton2 = CGRectGetWidth(self.likeBtn.frame) +CGRectGetWidth(self.exportBtn.frame)+ CGRectGetWidth(self.deleteBtn.frame)+(CGRectGetWidth(self.shareBtn.frame) / 2); //4
